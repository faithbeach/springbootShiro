<template>
  <div class="app-container">
    <div class="filter-container">
      <el-form>
        <el-form-item>
          ...
          <el-button type="success" icon="plus" v-if="hasPerm('user:add')" @click="showMenuCreate">添加菜单权限
          </el-button>
        </el-form-item>
      </el-form>
    </div>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form v-if="dialogStatus=='create'||dialogStatus=='update'" class="small-space" :model="tempRole" label-position="left" label-width="100px"
      ...
      <el-form v-if="dialogStatus=='createMenu'" class="small-spacemenu" :model="tempMenu" label-position="left" label-width="100px"
              style='width: 600px; margin-left:50px;'>
        ...
        <el-form-item label="菜单代号" required>
          <el-input type="text" v-model="tempMenu.menuCode" style="width: 250px;">
          </el-input>
        </el-form-item>
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button v-else-if="dialogStatus=='createMenu'" type="success" @click="createMenu">创 建</el-button>
